...
const CreateForm = ({ editData, onSuccess }) => {
    ...
    try {
      ...
      if (editData) {
        res = await axiosInstance.put(
          `/api/experiencelanding/${editData._id}`,
          data,
        );
      } else {
        res = await axiosInstance.post("/api/experiencelanding", data);
      }

      alert("Saved Successfully!");
       router.push("/dashboard/experiences/landing");
