...
const AccommodationLandingForm = ({ editData, onSuccess }) => {
    ...
    try {
      ...
      if (editData) {
        res = await axiosInstance.put(
          `/api/accommodationlanding/${editData._id}`,
          data,
        );
      } else {
        res = await axiosInstance.post("/api/accommodationlanding", data);
      }

      alert("Saved Successfully!");
       router.push("/dashboard/accommodations/landing");
...
export default AccommodationLandingForm