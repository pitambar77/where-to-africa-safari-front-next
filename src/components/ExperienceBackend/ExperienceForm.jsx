...
//     initialData.gallery?.description || "",
//   );
...
//     setGameDrives([
//       ...gameDrives,
//       { name: "", description: "", pricePerPerson: "", image: "" },
//     ]);
//   const addHighlight = () =>
//     setHighlights([...highlights, { name: "", image: "", description: "" }]);
//   const addGalleryImage = () =>
//     setGalleryImages([...galleryImages, { name: "", image: "" }]);
...
//           onChange={(e) =>
//             handleNestedChange("overview", "title", e.target.value)
//           }
//           className="w-full border rounded p-2 mb-3"
//         />
//         <input
  ...
  const handleSubmit = (e) => {
    ...
    gameDrives.forEach((g) => {
      if (g.image instanceof File) {
        data.append("gameDriveImages", g.image);
      }
    });
    ...
    highlights.forEach((h) => {
      if (h.image instanceof File) {
        data.append("highlightImages", h.image);
      }
    });
