...
const safarisData = [
  {
    id: 1,
    country: "Botswana",
    title: "6 Nights Anantara Vacation",
    nights: 6,
    price: 10700,
    image:
...
const MozambiqueLanding = () => {
  return (
   <div>
      <Banner
        title="Explore our Mozambique "
      ...
      title="Your Journeys"
      subtitle="Mozambique Trips to Inspire"
      data={safarisData}
...
export default MozambiqueLanding