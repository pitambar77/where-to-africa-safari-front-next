...
const areas = [
  {
    name: "Masaai Mara National Park",
    path: "/cape-town",
    image:
...
const safarisData = [
  {
    id: 1,
    country: "Kenya",
    title: "Sky Safari Kenya 10 Day",
    nights: 5,
    price: 10700,
    image:
      "https://cdn.kuoni.co.uk/media/exports/KuoniUK/ImageGalleryLightboxLarge/519526_ImageGalleryLightboxLarge.jpg",
  },
  {
    id: 2,
    country: "Kenya",
    title: "Explore's Favourite",
    nights: 11,
    price: 9300,
    image:
  ...
  },
  {
    ...
    price: 13500,
    image:
      "https://carminesafaris.com/wp-content/uploads/2025/08/maarten-van-den-heuvel-3Gh-BnAavc8-unsplash-1536x1020.jpg",
  },
  {
    id: 4,
    country: "India",
  ...
  },
  {
    ...
    id: 7,
    country: "Diani",
    title: "Diani Deferral",
    nights: 8,
    price: 18900,
    image:"https://content.r9cdn.net/rimg/dimg/85/ac/09a0a8d3-city-61964-16926991e06.jpg?width=1366&height=768&xhint=1599&yhint=995&crop=true",
  },
];
...
const KenyaLanding = () => {
  return (
    <div>
        <Banner
        title="Explore our Kenya "
        subtitle="World Elephant Day 2025 unites experts and citizens to safeguard matriarchs, memories, and habitat. "
        imageUrl="https://static.independent.co.uk/2022/11/07/12/GettyImages-178586669%20%281%29.jpg"
      ...
      title="Your Journeys"
      subtitle="Kenya Trips to Inspire"
      data={safarisData}
