  ...
  return (
    <div className="p-6">
      <div className="flex justify-between mb-6">
        ...
        <button
          onClick={() => router.push("/dashboard/homepage/create")}
          ...
          {data.map((item) => (
            <tr key={item._id}>
              ...
              <td className="border p-2 space-x-2">
                <Link
                  href={`/dashboard/homepage/${item._id}`}
                ...
                <button
                  onClick={() =>
                    router.push(`/dashboard/homepage/${item._id}`)
                  }
                ...
                <button
                  onClick={() =>
                    router.push(`/dashboard/homepage/seo/${item._id}`)
                  }
